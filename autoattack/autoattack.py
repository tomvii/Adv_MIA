...
class AutoAttack():
    def __init__(self, model, classNum, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if version in ['standard', 'plus', 'rand']:
            self.set_version(version, classNum-1)
    ...
    def set_version(self, version='standard', n_target_classes=1):
        if self.verbose:
        ...
        if version == 'standard':
            ...
            if self.norm in ['Linf', 'L2']:
                ...
                self.apgd_targeted.n_target_classes = n_target_classes
            ...
            self.fab.n_target_classes = n_target_classes
